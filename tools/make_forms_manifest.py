...
BASIC_DESC = {
    ...
    "개인정보수집이용동의서_한국동물병원협회": ("개인정보 수집·이용 동의서",
        "진료 예약·안내를 위한 보호자 개인정보 수집·이용 목적, 항목, 보유기간을 안내하고 동의를 받습니다.",
        "개인정보 수집 이용 동의 보호자"),
    "사진영상촬영SNS활용동의서_한국동물병원협회": ("사진·영상 촬영 및 SNS·홍보 활용 동의서",
        "진료 사진·영상을 병원 SNS·홈페이지에 게시하기 전 촬영 목적과 활용 범위, 비공개·삭제 요청을 안내하고 동의를 받습니다.",
        "사진 영상 촬영 SNS 홍보 초상권 동의"),
}
...
OFFICIAL_CAT_LABEL = {
    ...
    "05_운영안내": "운영 안내 · 가이드라인", "06_동물등록": "동물등록",
    "07_법정서식": "법정 서식 (최신본 직접 확인)",
}
